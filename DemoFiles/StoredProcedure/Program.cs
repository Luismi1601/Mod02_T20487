    ...
    class Program
    {
        static void Main(string[] args)
        {
            using(var context = new SchoolContext())
            {
                ...
                WriteLine($"Average grade for the course is {averageGradeInCourse}");
                ...
                WriteLine($"Average grade for the course is after 10 points upgrade is {averageGradeInCourseAfterGradesUpdate}");
